...
let canciones = [
  {
    id: 1,
    caratula: "pictures/CTB.jpg",
    cancion: "songs/y2meta.com - Becky G, Paulo Londra - Cuando Te Besé (Official Video) (256 kbps).mp3",
    artista: "Paulo Londra",
    titulo: "Cuando Te Besé",
  },
  {
    id: 2,
    caratula: "pictures/EPD.jpg",
    cancion: "songs/y2meta.com - Enrique Iglesias - El Perdedor (Pop) ft. Marco Antonio Solís (256 kbps).mp3",
    artista: "Enrique Iglesias",
    titulo: "El Perdedor",
  },
  {
    id: 3,
    caratula: "pictures/TLV.jpg",
    cancion: "songs/y2meta.com - Paulo Londra - Tal Vez (Official Video) (256 kbps).mp3",
    artista: "Paulo Londra",
    titulo: "Tal Vez",
  },
  {
    id: 4,
    caratula: "pictures/TRN.jpg",
    cancion: "songs/y2meta.com - Sebastián Yatra - Traicionera (256 kbps).mp3",
    artista: "Sebastián Yatra ",
    titulo: "Traicionera",
  },
  {
    id: 5,
    caratula: "pictures/YNT.jpg",
    cancion: "songs/y2meta.com - Sebastián Yatra, Mau y Ricky - Ya No Tiene Novio (256 kbps).mp3",
    artista: "Sebastián Yatra",
    titulo: "Ya No Tiene Novio",
  },
];
